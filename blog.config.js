...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '一片试验田', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '单击此处以编辑', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://093724.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '试验田, 博客, 李嘉', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '嘉ICP备114514号', // 备案号 闽ICP备XXXXXX
